...
public class CarryOut extends BaseAction {
	...
	//来源为生产部的新产品  来源为工程部的退回品 
	public static String queryString = " from Proflow where 1=1 and overmark='0' and curware='2' and prosource in ('1','3') ";
	...
	public void carryOut() {
		...
		if(this.getSendarea()==null)
		{
			this.setResult(false);
			this.setRtntxt("发送地区不能为空");
		}
