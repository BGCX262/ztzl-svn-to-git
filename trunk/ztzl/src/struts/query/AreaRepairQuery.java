...
public class AreaRepairQuery extends struts.BaseAction {
	...
	private static String queryString = " from Prorepair where 1=1  ";
	...
	public String exe() {
		...
		String queryString=AreaRepairQuery.queryString + " and area= '"+ userarea +"' ";
	...
	public void wareHousing() {
		...
		for (Object obj : list) {
			...
			} else		
			{
				...
				proFlow.setTypeid(Long.valueOf(this.getTypeid()));
			}
	...
	public static void setQueryString(String queryString) {
		AreaRepairQuery.queryString = queryString;
	}
