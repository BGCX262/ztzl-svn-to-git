...
public class ProWareQuery extends struts.BaseAction {
	...
	public static String queryString="from Proflow where id in (select max(id)  from Proflow where returnmark='0'  group by procode)  ";
