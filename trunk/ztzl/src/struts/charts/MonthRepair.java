...
public class MonthRepair extends struts.BaseAction {
	...
	private static String queryString = " select to_char(senddate,'yyyy-mm') as mn ,count(*) as cn from Prorepair where 1=1 ";
	private static String order = " group by to_char(senddate,'yyyy-mm')  ";
	...
	public static void setQueryString(String queryString) {
		MonthRepair.queryString = queryString;
	}
