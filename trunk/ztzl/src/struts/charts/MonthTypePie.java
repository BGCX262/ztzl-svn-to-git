...
public class MonthTypePie extends struts.BaseAction {
	...
	private static String queryString = " select typeid as mn ,count(*) as cn from Products where 1=1 ";
	private static String order = " group by typeid  ";
	...
	public static void setQueryString(String queryString) {
		MonthTypePie.queryString = queryString;
	}
