...
public class Common {
	...
	/**
	  ...
	  /**
	   * 校验产品编码
	   * @param procode 要校验的产品编码
	   * @return 如果符合规则返回true,否则返回false
	   */
	  public static boolean procodeValid(String procode)
	  {
//		  if(procode.length()!=12)
//			  return false;
		  
//		  if(Integer.valueOf(procode.substring(2, 2))>13)
//			  return false;
//		  
//		  if(str2date(procode.substring(4,2)+"-"+procode.substring(6,2)+"-01")==null)
//			  return false;
	  ...
	  public static void main(String[] args) {
	    ...
	    System.out.println("zhangzhongwei".substring(0,2));
	  }
