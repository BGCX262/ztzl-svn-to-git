Ext.onReady(function() {
	...
	function getList(action) {
		myObject = Json.evaluate(action.responseText);
	...
	Ext.get('enginadd').remove();
	Ext.get('enginmodi').remove();
	Ext.get('engindel').remove();
