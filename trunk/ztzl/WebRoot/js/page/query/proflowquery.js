Ext.onReady(function() {
	...
	genGrid = new GenGrid({
				...
				actionurl : '.\/json\/proflowquery.action',
				autoHeight : true,
	...
	var qpn = new Ext.Toolbar({
		...
		items : [{
					...
					text : '入库',
					handler : function() {
						genGrid.getData(1, 25, ' and  prosource= \'1\'  and sendto=\'2\' ');
					}
				}, {
					text : '出库',
					handler : function() {
						genGrid.getData(1, 25,' and  prosource= \'2\'  and sendto=\'3\' ');
					}
				}, {
					text : '退库',
					handler : function() {
						genGrid.getData(1, 25, ' and  prosource= \'3\'  and sendto=\'2\' ');
					}
				}, {
					text : '送检',
					handler : function() {
						genGrid.getData(1, 25, ' and  prosource= \'3\'  and sendto=\'4\' ');
					}
				}, {
					text : '维修',
					handler : function() {
						genGrid.getData(1, 25, ' and  prosource= \'2\'  and sendto=\'1\' ');
					}
				}]
	});
